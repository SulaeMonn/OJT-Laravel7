                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.confirm') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="address" id="address" cols="30" rows="5"
                                        class="form-control @error('dob') is-invalid @enderror"></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="file" class="form-control @error('dob') is-invalid @enderror"
                                        name="profile" required autofocus>
